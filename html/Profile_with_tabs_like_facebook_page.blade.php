                ...
                <div class="inner-all">
                    <ul class="list-unstyled">
                        <li class="text-center">
                            <img data-no-retina="" class="img-circle img-responsive img-bordered-primary" src="conan.jpg" alt="HA MINH DUC">
                        </li>
                        <li class="text-center">
    ...
    <div class="profile-cover">
        <div class="cover rounded shadow no-overflow">
            <div class="inner-cover">
                ...
                <img  src="img.jpg" class="img-responsive full-width" alt="cover" style="max-height:200px;">
            </div>
