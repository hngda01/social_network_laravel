            ...
            <form action="createPost" method="POST" role="form" enctype="multipart/form-data">
              ...
              <div class="form-group">   
                <table width="100%">
                  <tr>
                    <td width="33%">
                      {{-- <select name="category_select" style="width: 100%;" class="form-control" id="drop_down">

                        @foreach($category as $cat)
                        <option value="{{$cat->id}}" onclick="hideOther();">{{$cat->name}}</option>
                        @endforeach
                        <option value="0" id="otherOption" onclick="showOther();">Others</option>
                      </select> --}}
                    ...
                    <td width="33%">
                      <select name="privacy_select" style="width: 100%;" class="form-control">           
